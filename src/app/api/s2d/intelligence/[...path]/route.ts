...
const SAMPLE_SIGNALS: SignalRecord[] = [
  ...
  {
    snapshotId: "sig-006",
    locality: { stateCode: "04", stateName: "Melaka", parliamentCode: "137", parliamentName: "Hang Tuah Jaya", dunCode: "16", dunName: "Ayer Keroh", localityName: "Ayer Keroh" },
    politicalEntity: "PH",
  ...
  {
    snapshotId: "sig-007",
    locality: { stateCode: "04", stateName: "Melaka", parliamentCode: "134", parliamentName: "Masjid Tanah", dunCode: "01", dunName: "Kuala Linggi", localityName: "Kuala Linggi" },
    politicalEntity: "PH",
    issue: "Flood mitigation",
    platform: "Facebook",
    sourceType: "SOCIAL_MEDIA",
    language: "ms",
    sentimentLabel: "Neutral",
  ...
  {
    snapshotId: "sig-008",
    locality: { stateCode: "04", stateName: "Melaka", parliamentCode: "139", parliamentName: "Jasin", dunCode: "24", dunName: "Bemban", localityName: "Bemban" },
    politicalEntity: "BN",
